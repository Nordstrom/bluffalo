 ...
 * message.
 *
 * NOTE: I have renamed this class to `CommandLineParser` to avoid a naming conflict with the
 * built-int `CommandLine` class provided by Swift. This is necessary as we include these
 * source files directly into the project. - eric.chamberlain@hotmail.com
 */
